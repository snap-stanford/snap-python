...
:class:`TNGraph`, :class:`TUNGraph`, and :class:`TNEANet`::
  ...
  print 'Size SCC of Directed Graph: %f' % snap.GetMxSccSz(Graph)

  UGraph = snap.GenRndGnm(snap.PUNGraph, 20, 10)
  print 'Size SCC of Undirected Graph: %f' % snap.GetMxSccSz(UGraph)

  Network = snap.GenRndGnm(snap.PNEANet, 20, 10)
  print 'Size SCC of Network: %f' % snap.GetMxSccSz(Network)
