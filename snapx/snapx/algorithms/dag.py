...
# from snapx.algorithms.traversal.breadth_first_search import descendants_at_distance
# from snapx.generators.trees import NIL
...
#             new_stack = [t for t in stack if not (
#                 (t in TC[x]) or (x in TC[t]))]
