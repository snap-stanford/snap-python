...
import snapx as sx 
from snapx.testing.utils import assert_nodes_equal
...
class BaseDiGraphTester(BaseGraphTester):
    ...
    def test_edges(self):
        ...
        assert sorted(G.edges([0, 1])) == [(0, 1), (0, 2), (1, 2)]
        with pytest.raises(sx.SnapXError):
            G.edges(-1)

    def test_out_edges(self):
        G = self.K3
        assert sorted(G.out_edges()) == [(0, 1), (0, 2), (1, 2)]
...
class TestDiGraph(BaseAttrDiGraphTester):
    ...
    def setup_method(self):
        ...
        self.P3.add_edges_from(self.p3edges)
        self.P3.add_nodes_from(self.p3nodes)
